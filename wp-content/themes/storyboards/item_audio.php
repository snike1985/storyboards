 <div class="clearfix">             
    ...
    <div class="col-lg-6 col-md-6" style="min-width:500px">
        	<div style="margin:0 0 10px 0px"><img src="<?php echo($pvs_theme_content[ 'photo' ]);?> "></div>
			...
			<?php }?>
			<?php if ($pvs_theme_content[ 'source' ] ) {?>
				<span><b><?php echo(pvs_word_lang("source"));?>:</b> <?php echo($pvs_theme_content[ 'source' ]);?></span>
			<?php }?>
