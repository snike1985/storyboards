...
$pvs_theme_content[ 'print_content' ] = '<div class="home_box" style="border:0">
	...
	<div class="galaxy_cases_small" style="background:url(\'' . $pvs_theme_content[ 'item_img2' ] . '\');background-size:cover;background-position:center center">
		<a href="' . $pvs_theme_content[ 'print_url' ] . '"><img src="' . pvs_plugins_url() . '/includes/prints/images/galaxy_overlay_small.png"></a>
	</div>';
