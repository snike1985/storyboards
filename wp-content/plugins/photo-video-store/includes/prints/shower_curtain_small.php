...
$pvs_theme_content[ 'print_content' ] = '<div class="home_box" style="border:0">
	...
	<div class="curtain_small" style="background:url(\'' . $pvs_theme_content[ 'item_img2' ] . '\');background-size:cover;background-position:center center">
		<a href="' . $pvs_theme_content[ 'print_url' ] . '"><img src="' . pvs_plugins_url() . '/includes/prints/images/curtain_small.png"></a>
	</div>';
