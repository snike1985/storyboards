...
/*
include("Exceptions/AmountTooLargeException.php");
include("Exceptions/AmountUnderMinimumException.php");
include("Exceptions/CurrencyNotSupportedException.php");
include("Exceptions/UrlTooLongException.php");
include("Exceptions/VariableTooLongException.php");
*/
/**
 * Class Payment
...
class Payment
{
    ...
    */
     ...
     * @return string
     */
    public function getpvs_currency()
    {
     ...
     * @return $this
     */
    public function setpvs_currency($currency)
    {
        if($currency != 'EUR')
