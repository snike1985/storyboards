...
class GopayHelper {
	 ...
	 * @param string $secureKey - kryptovaci klic prideleny uzivateli, urceny k podepisovani komunikace
  	 * @return retezec pro podpis
  	 */
  	public static function concatPaymentpvs_result($paymentSessionId, $result, $secureKey) {
    ...
    */
	 ...
	 * @throw Exception
	 */
	public static function checkPaymentpvs_result($returnedPaymentSessionId,
											$returnedEncryptedSignature,
											$paymentResult,
								  			$paymentSessionId,
								  			$secureKey) {
		...
		$hashedSignature = GopayHelper::hash(
								GopayHelper::concatPaymentpvs_result(
