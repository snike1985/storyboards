...
class WebToPay_RequestBuilder {
     ...
     *
     * Array structure:
     *   name      òÀÓ request item name
     *   maxlen    òÀÓ max allowed value for item
     *   required  òÀÓ is this item is required
     *   regexp    òÀÓ regexp to test item value
     *
     * @return array
     */
...
class WebToPay_PaymentMethod {
     ...
     * @param string $baseCurrency
     */
    public function setBasepvs_currency($baseCurrency)
    {
        $this->baseCurrency = $baseCurrency;
    }
     ...
     * @return string
     */
    public function getBasepvs_currency()
    {
