...
class AmazonS3 extends CFRuntime
{
	...
	const REGION_EU_W2 = 'eu-central-1';
	...
	public function set_region($region)
	{
		switch ($region)
		{
			...
			case self::REGION_US_W1: // Northern Virginia
				$this->set_hostname('s3-us-west-1.amazonaws.com');
				$this->enable_path_style(false);
				break;
				
			case self::REGION_US_W2: // (Oregon)
				$this->set_hostname('s3-us-west-2.amazonaws.com');
				$this->enable_path_style(false);
				break;

			case self::REGION_EU_W1: // Ireland
				$this->set_hostname('s3-eu-west-1.amazonaws.com');
				$this->enable_path_style(); 
				break;
				
			case self::REGION_EU_W2: // Frankfurt
				$this->set_hostname('s3-eu-central-1.amazonaws.com');
				$this->enable_path_style(); 
				break;
				
			case self::REGION_APAC_SE1: // Singapore
				$this->set_hostname('s3-ap-southeast-1.amazonaws.com');
				$this->enable_path_style(); 
				break;
				
			case self::REGION_APAC_SE2: // Sydney
				$this->set_hostname('s3-ap-southeast-2.amazonaws.com');
				$this->enable_path_style(); 
				break;
				
			case self::REGION_APAC_NE1: // Japan
				$this->set_hostname('s3-ap-northeast-1.amazonaws.com');
				$this->enable_path_style(); 
				break;
				
			case self::REGION_SA_E1: // Sao Paulo
				$this->set_hostname('s3-sa-east-1.amazonaws.com');
				$this->enable_path_style(); 
				break;
