...
?>
<form method="post">
	<input type="hidden" name="action" value="frames_add">
...
<?php
$n = 0;
$sql = "select * from " . PVS_DB_PREFIX . "video_frames order by name";
$rs->open( $sql );
if ( ! $rs->eof )
{
?>
	<form method="post">
	<input type="hidden" name="action" value="frames_delete">
