...
if ( @$_REQUEST["action"] == 'new' ) {
	...
	<?php
		...
		while ( ! $rs->eof ) {
			...
			$cl3 = "";
			$cl_script = "";
			if ( isset( $_SESSION["user_credits_id"] ) and ! isset( $_SESSION["admin_rows_credits" .
				$rs->row["id_parent"]] ) and $rs->row["id_parent"] > $_SESSION["user_credits_id"] and
				$_SESSION["user_credits_id"] > 0 ) {
