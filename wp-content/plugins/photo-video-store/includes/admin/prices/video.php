...
<p>* You may add ANY video type. You should use "," as separator. Example types: wmv,avi,mov</p>
...
<td><input type="text" name="types" value="avi" style="width:100px"></td>
...
<?php
	...
	{
?>
<b>The video type has been added successfully.</b>
<?php
	}
	if ( $_GET["type"] == "change" )
	{
?>
<b>The video types have been changed successfully.</b>
<?php
	}
...
?>
<form method="post">
<input type="hidden" name="action" value="video_change">
<table class="wp-list-table widefat fixed striped posts">
<thead>
<tr>
